	...
	$(document)
			.ready(
					function() {
						...
						$
								.ajax({
									url : "/Project_Final/recruit_board_view/"
											+ param,
										...
										$
												.each(
														...
														function(idx, item) {
															...
															$("#val5")
																	.text(
																			GetFormattedDate(item.RECRUIT_REGISTRATIONDATE));
															$("#val6")
																	.text(
																			item.RECRUIT_SIZE);
															$("#val7")
															...
															$("#val10")
																	.text(
																			GetFormattedDate(item.RECRUIT_DEADLINE));
															$("#val11")
																	.text(
																			item.RECRUIT_BUSINESSTYPE);
															$("#val12")
																	.text(
																			item.RECRUIT_INFO);
															$("#val13")
																	.text(
																			item.RECRUIT_ADDRESS);
															$("#val14")
																	.text(
																			item.RECRUIT_WIDE);
															$("#val15")
																	.text(
																			GetFormattedDate(item.RECRUIT_STARTWORKDATE));
															$("#val16")
																	.text(
																			GetFormattedDate(item.RECRUIT_ENDWORKDATE));
															$("#val17")
																	.text(
																			item.RECRUIT_STARTWORKTIME);
															$("#val18")
																	.text(
																			item.RECRUIT_ENDWORKTIME);
															$("#val19")
																	.text(
						...
						$('#recruit_submit').click(
								function() {
									var number = $("#val1").text();
									console.log(number)

									$.ajax({
										url : "recruit_submit?recruit_number="
												+ number,
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-10" style="height: 40px;">
									...
									<button class="btn btn-theme" type="submit"
										style="position: absolute; right: 20px;" id="recruit_submit">지원</button>
								</div>
							</div>
						</div>
						</div>
