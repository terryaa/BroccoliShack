			...
			.ready(
					function() {
						...
						$(document.body).delegate('tr', 'click', function() {
							...
							location.href = 'recruit_board?num=' + selected;
						});
			...
			<section class="wrapper">
				...
				<div class="form-panel">
					<form action="#" class="form-horizontal style-form">
						<h4>구인</h4>
						<a href="recruit_insert.html" class="btn btn-success" style="float: right;">글쓰기</a>
						...
						<div class="content-panel">
							...
							<table class="table" id="taginserttable">
								<thead>
									<tr>
										<th class="hidden-phone">게시판 번호</th>
										<th class="hidden-phone">지역</th>
										<th class="hidden-phone">작물</th>
										<th>일급</th>
										<th>마감일</th>
									</tr>
								</thead>
